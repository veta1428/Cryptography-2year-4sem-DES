namespace DES
{
    ...
    {
        public const int ExtendedKeySizeBytes = 8;
        public const int KeyLengthString = 7;
        public const int ExtendedKeySizeBits = 64;
        public const int KeySizeBits = 56;
        public const int Rounds = 16;
        public const int RoundKeySize = 48;
        public const int HalfBlockSizeBits = 32;
        public const int BlockSizeBits = 64;
        public const int BlockSizeBytes = 8;
        public const int ExpandeHalfSizeBits = 48;

        //initial key part separation
        public static readonly int[] CD =  new int[]{  57, 49, 41, 33, 25, 17, 9,
                                1, 58, 50, 42, 34, 26, 18,
                                10, 2, 59, 51, 43, 35, 27,
                                19, 11, 3, 60, 52, 44, 36,
        ...
        public static readonly int[] shift = new int[] { 1, 1, 2, 2, 2, 2, 2, 2, 1, 2, 2, 2, 2, 2, 2, 1 };

        //reduce round key
        public static readonly int[] CP = new int[]{  14, 17, 11, 24, 1, 5,
                                3, 28, 15, 6, 21, 10,
                                23, 19, 12, 4, 26, 8,
                                16, 7, 27, 20, 13, 2,
                                41, 52, 31, 37, 47, 55,
        ...
        public static readonly int[] IP_R = {   40 ,8  ,48 ,16 ,56 ,24 ,64 ,32 ,
        ...
        public static readonly byte[][][] S_boxes = new byte[][][]{
                                new byte[][]{
        ...
        //expanding
        public static readonly int[] E = new int[]{   32 ,1  ,2  ,3  ,4  ,5  ,
        4  ,5  ,6  ,7  ,8  ,9  ,
        8  ,9  ,10 ,11 ,12 ,13 ,
        12 ,13 ,14 ,15 ,16 ,17 ,
        16 ,17 ,18 ,19 ,20 ,21 ,
